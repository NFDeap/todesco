...
@section('content')
<div class="container">
    <h5 class="center">Lista de Papéis para <b>{{ $usuario->name }}</b></h5>
    ...
    <br>
        ...
        <div class="row">
            ...
            <button class="btn btncar">Adicionar</button>
            </form>
            ...
            <table>
                ...
                @foreach($usuario->papeis as $papel)
                    <tr>
                        ...
                        <td>                            
                            <a class="btn btn3" href="javascript: if(confirm('Remover esse Papel?')){window.location.href = '{{ route('admin.usuarios.papel.remover',[$usuario->id,$papel->id]) }}'}">Remover</a>
                        </td>
                    </tr>
                @endforeach    
                </tbody>
